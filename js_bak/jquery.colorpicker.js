(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            $("body").append('<div id="colorpanel" style="position: absolute; display: none;z-index:9999999;"></div>');
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose"><font size="2">关闭</font></a> | <a href="javascript:void(0);" id="_creset"><font size="2">清除</font></a></td></tr></table></td></table>'
